package c.product.createproduct.utils;
...
public class Conexion {
    ...
    String url = "jdbc:mysql://localhost/datos_alumnos"; //Url de la base de datos

    String user = "root"; //Usuario

    String pass= "alejandro"; //Contraseña de la base de datos
